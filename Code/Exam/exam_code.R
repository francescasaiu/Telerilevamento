...
im.multiframe(3,3)
plot(oc27, main="October 27")
plot(oc29, main="October 29")
plot(oc30, main="October 30")
plot(oc31, main="October 31")
plot(nov4, main="November 4")
plot(nov7, main="November 7")
plot(nov12, main="November 12")
plot(nov29, main="November 29")
plot(dec30, main="December 30")
...
im.multiframe(3,4)
plot(oc27[[1]], col=viridis(100), main="October 27")
